...
"""
This Scratchpad measures Cell, Average Cell, Filtered Cell and SPINS for n-loops with Lion rev C or higher (ADBMS6830).
...
def main():
    # Open the interface
    interface = USB_TO_SPI_BYTE('/dev/ttyACM0', 115200, stdout=False)
    # Create BMW Object
    bms = BMS(interface)
    # Add device to board list. For multiple boards use: [{'Device': ADBMS6830},{'Device': ADBMS6830}]
